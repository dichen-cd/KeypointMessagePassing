...
def get_default_config():
    ...
    # for model vg_interact, load a pre-trained visual-only PCB model.
    cfg.model.pcb_pretrained_path = 'logs/v0.3.2/Jul03_21-53-45_TITAN-RTX/model/model.pth.tar-45'
